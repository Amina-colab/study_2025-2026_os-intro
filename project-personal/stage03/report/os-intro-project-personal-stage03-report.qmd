...
Для того чтобы опубликовать новые посты, я создала папки под названием `2 week` и `markdown`, где в каждой папке хранится файл в формате markdown с текстом для публикации.

![Создание папок необходимых](./image/01.png){ #fig:001 width=70% height=70% }

## 2. Добавление информации о достижениях, навыках и опыте

В раздел `awards`, `skills`, `experience` добавлена соответсвующая информация.
...
Создан пост на тему "Язык разметки Markdown", в котором рассказано об языке разметки Markdown.
