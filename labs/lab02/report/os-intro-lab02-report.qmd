...
Устанавливаем git, git-flow и gh и xclip.
...
![rsa-4096](./image/04.png){ #fig:004 width=70% height=70% }

![ed25519](./image/05.png){ #fig:005 width=70% height=70% }
...
![GPG ключ](image/07.png){ #fig:007 width=70% height=70% }

Настройка автоматических подписей коммитов git

![Параметры репозитория](./image/08.png){ #fig:008 width=70% height=70% }
![Параметры репозитория](./image/09.png){ #fig:009 width=70% height=70% }

Настройка gh

![Связь репозитория с аккаунтом](./image/10.png){ #fig:010 width=70% height=70% }

Загрузка шаблона репозитория и синхронизация

![Загрузка шаблона](./image/11.png){ #fig:011 width=70% height=70% }

Подготовка репозитория и коммит изменений, отправка на репозиторий.
![Клонирование](./image/12.png){ #fig:012 width=70% height=70% }

![Rоммит](./image/13.png){ #fig:013 width=70% height=70% }

![Push](./image/14.png){ #fig:014 width=70% height=70% }
