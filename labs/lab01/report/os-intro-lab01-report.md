...
![Установка языка](./image/04.png){ #fig:004 width=70% height=70% }

Указываю параметры установки. Установка завершилась 

![Завершение установки](./image/05.png){ #fig:005 width=70% height=70% }

Создаю пользователя и захожу в учетную запись

![Вход в учетную запись](./image/06.png){ #fig:006 width=70% height=70% }
...
![Команда dmesg](./image/07.png){ #fig:007 width=70% height=70% }

6. Тип файловой системы корневого раздела.

7. Последовательность монтирования файловых систем

![Команда dmesg](./image/08.png){ #fig:008 width=70% height=70% }
